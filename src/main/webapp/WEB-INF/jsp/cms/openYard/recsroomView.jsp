...
<head>
	...
	<!-- js File import -->
	<script type="text/javascript" src="<c:url value='/js/cms/openYard/recsroomView.js' />"></script>
        ...
        <div class="container">
            ...
            <div class="cont">
                ...
                <div class="btn_wrap right mb40">
                    <%-- <a href="javascript:void(0)" class="btn btn_blue" onClick="updatePage('${result.recsroom_no}');">수정</a> --%>
