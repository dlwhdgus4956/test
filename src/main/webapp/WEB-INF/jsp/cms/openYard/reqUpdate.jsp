...
<body>
        ...
        <div class="container">
            ...
            <div class="cont">
                ...
                <div class="btn_wrap right mb40">
                    ...
                    <a href="javascript:void(0)" class="btn btn_red" onClick="fn_delete('${result.req_no}');">삭제</a>
    ...
    <!-- js File import -->
	<script type="text/javascript" src="<c:url value='/js/cms/openYard/reqUpdate.js' />"></script>
