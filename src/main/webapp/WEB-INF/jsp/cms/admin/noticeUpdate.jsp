...
<body>
    ...
    <section>
        <div class="container">
            ...
            <div class="cont">
				...
				<input type="hidden" id="noticeNo" name="noticeNo" value="${result.notice_no}" readonly="readonly"/>
                ...
                <div class="btn_wrap right mb40">
                    ...
                    <a href="javascript:void(0)" class="btn btn_red" onClick="fn_delete('${result.notice_no}');">삭제</a>
    ...
    <!-- js File import -->
	<script type="text/javascript" src="<c:url value='/js/cms/admin/noticeUpdate.js' />"></script>
