...
<body>
        ...
        <div class="container">
		    ...
		    <div class="cont">
				...
				<div class="tbl_wrap">
					    ...
					    <thead>
				   		...
				   		<tbody>
		            		...
		            		<c:forEach var="result" items="${resultList}" varStatus="status">
                				<tr onclick="view('${result.user_id}');" style="cursor:pointer">
			                    	<td><c:out value="${(rowNumber)-status.count +1}" /></td>
			                      	...
			                      	<td><c:out value="${result.auth_nm}" /></td>
			                      	<td>
				                      	<c:if test="${result.enabled eq '1'}">
				                      		<c:out value="사용" />
				                      	</c:if>
				                      	<c:if test="${result.enabled eq '0'}">
				                      		<c:out value="미사용" />
				                      	</c:if>
			                     	</td>
				                </tr>
					...
					<div>
						검색결과 : <fmt:formatNumber value="${totalCount}" pattern="#,###"/>건
					</div>
	            ...
	            <div class="btn_wrap right mb40">
	               	<a href="javascript:void(0)" onclick="add();">등록</a>
	                <!-- 
	                <a href="javascript:void(0)" class="btn btn_blue"><em class="ico_down"></em>엑셀</a> -->
	            </div>
	...
	<!-- js File import -->
	<script type="text/javascript" src="<c:url value='/js/cms/admin/memberList.js' />"></script>
