...
function addPage(){
	...
	$('#searchFrm').attr('action','/admin/recsroom/insert.do').submit();
}
...
function view(recsroomNo){
	...
	$('#searchFrm').attr('action','/admin/recsroom/view.do?recsroomNo='+recsroomNo).submit();
}
...
function goList(page) {
	...
	//fn_wrapLoading();
	$('#searchFrm').attr('action','/admin/recsroom/list.do').submit();
}
